...
/**
 * Renders children only when role === "super_admin" (from Supabase session).
...
export function SuperAdminRoute({
  ...
  useEffect(() => {
    ...
    if (role !== "super_admin") {
      const target =
        typeof fallbackTo === "function" ? fallbackTo(params) : fallbackTo;
      navigate(target, { replace: true });
    }
  }, [admin, isAuthLoading, navigate, fallbackTo, params]);
